...
reciver_email = "appleshard9@gmail.com"         # Email who send the email
sender_email = "noah.sommer08@gmail.com"        # Email who get the email
passwordsender = "jrwavuwhpntxagjc"             # go to the Google account , go to the settings, now security and press create an app password... [GOOD LUCK ✔]
